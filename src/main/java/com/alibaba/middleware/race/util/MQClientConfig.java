...
public class MQClientConfig implements Serializable {
	...
	//to support multiple-topic subscribtion
	...
	public MQClientConfig(String consumerGroup, String nameServer,
			String[] topics, String subExpress) {
	...
	public MQClientConfig(Map conf) {
		//modify at 2016-06-28
		topics = new String[]{(String) conf.get(META_TOPIC)};
